...
#define _FIELD(name,fieldtype,count,flags,mapname,tolerance)		{ fieldtype, #name, static_cast<int>(offsetof(classNameTypedef, name)), count, flags, mapname, NULL, NULL, NULL, sizeof( ((classNameTypedef *)0)->name ), NULL, 0, tolerance }
...
// INPUTS
#define DEFINE_INPUT( name, fieldtype, inputname ) { fieldtype, #name, static_cast<int>(offsetof(classNameTypedef, name)), 1, FTYPEDESC_INPUT | FTYPEDESC_SAVE | FTYPEDESC_KEY,	inputname, NULL, NULL, NULL, sizeof( ((classNameTypedef *)0)->name ) }
...
#define DEFINE_OUTPUT( name, outputname )	{ FIELD_CUSTOM, #name, static_cast<int>(offsetof(classNameTypedef, name)), 1, FTYPEDESC_OUTPUT | FTYPEDESC_SAVE | FTYPEDESC_KEY, outputname, eventFuncs }
