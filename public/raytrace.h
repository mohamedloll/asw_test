...
{
public:
	virtual bool VisitTriangle_ShouldContinue(const TriIntersectData_t& triangle, const FourRays& rays, i32x4* hitMask, fltx4* b0, fltx4* b1, fltx4* b2, int32 hitID) = 0;
};
