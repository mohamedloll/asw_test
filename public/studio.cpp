...
ConVar mod_load_preload("mod_load_preload", "1.0", 0, "Indicates how far ahead in seconds to preload animations.");
#ifdef _DEBUG
...
void CMDLPanel::SetMDL(const char*) {}
void CMDLPanel::SetMDL(unsigned short) {}
void CMDLPanel::SetSequence(int) {}
void CMDLPanel::SetModelAnglesAndPosition(const QAngle&, const Vector&) {}
bool CMDLPanel::GetBoundingBox(Vector&, Vector&) { return false; }

CMDL::~CMDL() {}
void CMDL::Draw(const matrix3x4_t&) {}

bool UpdateCurrentVideoConfig(int, int, int, bool, bool)
{
	return true;
}

void CParticleCollection::Render(IMatRenderContext*, const Vector4D&, bool, void*) {}
...
int CPackedStore::ReadData(CPackedStoreFileHandle&, void*, int)
{
	return 0;
}