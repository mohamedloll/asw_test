...
FORCEINLINE void CRC32_Init(CRC32_t* pulCRC)
{
	*pulCRC = CRC32_INIT_VALUE;
}

FORCEINLINE void CRC32_ProcessBuffer(CRC32_t* pulCRC, const void* pBuffer, int nBuffer)
{
...
FORCEINLINE void CRC32_Final(CRC32_t* pulCRC)
{
